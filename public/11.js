...
Component.options.__file = "resources\\assets\\js\\components\\views\\auth\\Register.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5db7d682", Component.options)
  } else {
    hotAPI.reload("data-v-5db7d682", Component.options)
  }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                // Update the user.
                _context.next = 11;
                return this.$store.dispatch('updateUser', { user: data });
...
var render = function() {
  ...
  return _c("div", { staticClass: "form-auth-wrap" }, [
    _c(
      ...
      [
        _c("h2", { staticClass: "form-auth-header" }, [_vm._v("Register")]),
        _vm._v(" "),
        ...
        _c("div", { staticClass: "form-group" }, [
          _c(
            "label",
            { staticClass: "sr-only", attrs: { for: "inputPasswordConfirm" } },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5db7d682", module.exports)
  }
}
