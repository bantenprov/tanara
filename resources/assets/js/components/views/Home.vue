    ...
    <div class="home-header">
      <div class="container">
        ...
        <div class="home-header-content">
          ...
          <p class="mb-0">
            <router-link class="btn btn-lg btn-light d-block d-sm-inline-block rounded-0 px-5 mx-2 mb-3 mb-sm-0" :to="{ name: 'dashboard' }"><i class="fa fa-th-large" aria-hidden="true"></i> Dashboard</router-link>
            <router-link class="btn btn-lg btn-outline-light d-block d-sm-inline-block rounded-0 px-5 mx-2 mb-3 mb-sm-0" :to="{ name: 'sign-in' }"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign in</router-link>
          </p>
        </div>
      </div><!-- /.container -->
