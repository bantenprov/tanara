<section class="shape shape-top shape-bottom text-center text-white bg-success">
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-6 mb-3">
                <img class="img-fluid w-100" src="/images/lukisan-syekh-nawawi-al-bantani-oleh-kang-alam.jpg" alt="Syekh Nawawi al-Bantani">
            </div><!-- /col -->
            <div class="col-sm-6 mb-3">
